...
const ProjectArea = styled.div`
  ...
  &::before {
    ...
    transform: rotate(0.5deg) translate(-1.8rem, -0.7rem);

    @media ${device.laptopL} {
      transform: rotate(0.5deg) translate(-2rem, -2rem);
      height: 45rem;
      width: 85%;
    }
  ...
  &::after {
    ...
    transform: rotate(4deg) translate(-1.8rem, -0.7rem);
    ...
    @media ${device.laptopL} {
      transform: rotate(20deg) translate(-1.8rem, -0.7rem);
      height: 40rem;
      width: 38%;
    }
    @media ${device.desktop} {
